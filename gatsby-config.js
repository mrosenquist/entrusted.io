      ...
      options: {
        headers: {
          '/*': [
            ...
            "Content-Security-Policy: connect-src 'self'; font-src data: 'self' https://*.cloudfront.net; img-src https://*.cloudfront.net 'self'; script-src 'self' www.google-analytics.com; style-src 'unsafe-inline' 'self'; default-src 'none'; report-uri https://entrustedio.report-uri.com/r/d/csp/enforce",
