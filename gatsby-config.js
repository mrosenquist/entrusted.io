      ...
      options: {
        headers: {
          '/*': [
            ...
            "Content-Security-Policy: connect-src 'self'; font-src 'self'; img-src 'self'; script-src 'self' www.google-analytics.com; style-src 'self'; default-src 'none'; report-uri https://entrustedio.report-uri.com/r/d/csp/enforce",
